...
use acute_macro_utils::{derive_label, get_named_struct_fields, AcuteManifest};
...
pub fn derive_system_label(input: TokenStream) -> TokenStream {
    ...
    let mut trait_path = acute_ecs_path();
...
pub(crate) fn acute_ecs_path() -> syn::Path {
    AcuteManifest::default().get_path("acute_ecs")
}
