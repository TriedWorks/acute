...
///
/// If no [ordering](https://github.com/acuteengine/acute/blob/main/examples/ecs/ecs_guide.rs)
...
/// [`add_event`](https://docs.rs/acute/*/acute/app/struct.App.html#method.add_event).
...
/// [`add_event`](https://docs.rs/acute/*/acute/app/struct.App.html#method.add_event).
///
/// [Example usage.](https://github.com/acuteengine/acute/blob/latest/examples/ecs/event.rs)
/// [Example usage standalone.](https://github.com/acuteengine/acute/blob/latest/acute_ecs/examples/events.rs)
///
#[derive(Debug)]
...
impl<'w, 's, E: Event> EventReader<'w, 's, E> {
    ...
    ///     }
    /// }
    /// # acute_ecs::system::assert_is_system(play_collision_sound);
    /// ```
