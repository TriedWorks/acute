...
pub use acute_ecs_macros::WorldQuery;
...
///
/// acute also offers a few filters like [`Added`](crate::query::Added), [`Changed`](crate::query::Changed),
...
/// use acute_ecs::query::WorldQuery;
///
/// #[derive(Component)]
/// struct Foo;
/// #[derive(Component)]
...
/// ```
/// # use acute_ecs::prelude::*;
/// use acute_ecs::{query::WorldQuery, component::Component};
///
/// #[derive(Component)]
/// struct Foo;
/// #[derive(Component)]
...
/// # use acute_ecs::query::ChangeTrackers;
