...
use acute_ecs_macros::all_tuples;
use acute_ptr::{ThinSlicePtr, UnsafeCellDeref};
...
///     }
/// }
/// # acute_ecs::system::assert_is_system(compliment_entity_system);
/// ```
...
///     }
/// }
/// # acute_ecs::system::assert_is_system(no_permit_system);
/// ```
...
/// ```
/// # use acute_ecs::component::Component;
/// # use acute_ecs::entity::Entity;
/// # use acute_ecs::query::Changed;
/// # use acute_ecs::query::Or;
/// # use acute_ecs::system::IntoSystem;
/// # use acute_ecs::system::Query;
/// #
...
///     }
/// }
/// # acute_ecs::system::assert_is_system(print_cool_entity_system);
/// ```
#[derive(Clone, Copy)]
...
impl_tick_filter!(
    ...
    /// }
    ///
    /// # acute_ecs::system::assert_is_system(print_add_name_component);
    /// ```
    Added,
...
impl_tick_filter!(
    ...
    /// acute does not compare components to their previous values.
    ///
    ...
    /// }
    ///
    /// # acute_ecs::system::assert_is_system(print_moving_objects_system);
    /// ```
    Changed,
