...
use acute_utils::tracing::{error, warn};
...
impl<'w, 's> Commands<'w, 's> {
    ...
    /// }
    /// # acute_ecs::system::assert_is_system(example_system);
    /// ```
    ...
    /// # }
    /// # acute_ecs::system::assert_is_system(initialise_scoreboard);
    /// ```
    ...
    /// ```
    /// # use acute_ecs::prelude::*;
    /// use acute_ecs::system::InsertBundle;
    /// #
    ...
    ///     });
    /// }
    /// # acute_ecs::system::assert_is_system(add_combat_stats_system);
    /// ```
...
impl<'w, 's, 'a> EntityCommands<'w, 's, 'a> {
    ...
    /// }
    /// # acute_ecs::system::assert_is_system(remove_combat_stats_system);
    /// ```
    ...
    /// }
    /// # acute_ecs::system::assert_is_system(convert_enemy_system);
    /// ```
    ...
    /// }
    /// # acute_ecs::system::assert_is_system(remove_character_system);
    /// ```
