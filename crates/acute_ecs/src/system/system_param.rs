...
pub use acute_ecs_macros::SystemParam;
use acute_ecs_macros::{all_tuples, impl_param_set};
use acute_ptr::UnsafeCellDeref;
use std::{
    fmt::Debug,
    marker::PhantomData,
    ops::{Deref, DerefMut},
...
/// use acute_ecs::system::SystemParam;
///
/// #[derive(SystemParam)]
/// struct MyParam<'w, 's> {
///     foo: Res<'w, usize>,
...
/// }
///
/// # acute_ecs::system::assert_is_system(my_system);
/// ```
///
...
/// ```
/// # use acute_ecs::prelude::*;
/// # use acute_ecs::system::assert_is_system;
/// struct Config(u32);
...
///
/// If you are using `acute_ecs` as a standalone crate,
/// note that the `RemovedComponents` list will not be automatically cleared for you,
/// and will need to be manually flushed using [`World::clear_trackers`]
///
/// For users of `acute` itself, this is automatically done in a system added by `MinimalPlugins`
...
/// # use acute_ecs::system::RemovedComponents;
/// #
/// # #[derive(Component)]
/// # struct MyComponent;
///
...
/// }
///
/// # acute_ecs::system::assert_is_system(react_on_removal);
/// ```
...
/// ```
/// # use acute_ecs::prelude::*;
/// use acute_ecs::system::{SystemParam, StaticSystemParam};
/// #[derive(SystemParam)]
...
///     acute_ecs::system::assert_is_system(do_thing_generically::<T>);
/// }
/// ```
...
mod tests {
    ...
    use crate::{
        self as acute_ecs, // Necessary for the `SystemParam` Derive when used inside `acute_ecs`.
        query::WorldQuery,
        system::Query,
    };
