...
///
/// ```
/// # use acute_ecs::component::Component;
/// # use acute_ecs::system::IntoSystem;
/// # use acute_ecs::system::Query;
/// # #[derive(Component)]
/// # struct ComponentA;
/// # #[derive(Component)]
/// # struct ComponentB;
...
/// # ) {}
/// # acute_ecs::system::assert_is_system(system);
/// ```
///
...
/// # ) {}
/// # acute_ecs::system::assert_is_system(tuple_system);
///
/// # fn non_tuple_system(
/// // This is the preferred method.
/// query: Query<&MyComponent>
/// # ) {}
/// # acute_ecs::system::assert_is_system(non_tuple_system);
/// ```
///
...
///     }
/// }
/// # acute_ecs::system::assert_is_system(immutable_query_system);
///
...
///     }
/// }
/// # acute_ecs::system::assert_is_system(mutable_query_system);
/// ```
///
...
impl<'w, 's, Q: WorldQuery, F: WorldQuery> Query<'w, 's, Q, F> {
    ...
    ///     }
    /// }
    /// # acute_ecs::system::assert_is_system(report_names_system);
    /// ```
    #[inline]
    ...
    ///     }
    /// }
    /// # acute_ecs::system::assert_is_system(gravity_system);
    /// ```
    #[inline]
    ...
    ///     }
    /// }
    /// # acute_ecs::system::assert_is_system(print_selected_character_name_system);
    /// ```
    #[inline]
    ...
    ///     }
    /// }
    /// # acute_ecs::system::assert_is_system(poison_system);
    /// ```
    #[inline]
    ...
    /// }
    /// # acute_ecs::system::assert_is_system(player_system);
    /// ```
    ///
    /// # Panics
    ///
    ...
    /// ```
    /// # use acute_ecs::prelude::*;
    /// # use acute_ecs::system::QuerySingleError;
    /// # #[derive(Component)]
    ...
    ///     }
    /// }
    /// # acute_ecs::system::assert_is_system(player_scoring_system);
    /// ```
    ...
    ///     health.0 += 1;
    /// }
    /// # acute_ecs::system::assert_is_system(regenerate_player_health_system);
    /// ```
    ///
    /// # Panics
    ///
    ...
    ///     }
    /// }
    /// # acute_ecs::system::assert_is_system(update_score_system);
    /// ```
    #[inline]
    ...
    ///     }
    /// }
    /// # acute_ecs::system::assert_is_system(targeting_system);
    /// ```
    #[inline]
