...
A refreshingly simple task executor for acute. :)
...
[`acute`][acute] as a lighter alternative to [`rayon`][rayon] for this specific usecase. There are also utilities for
